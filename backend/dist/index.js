...
app.get('/api/directory/faculty', auth_1.authenticateToken, adminController.getFacultyDirectory);
app.get('/api/directory/students', auth_1.authenticateToken, adminController.getStudentsDirectory);
