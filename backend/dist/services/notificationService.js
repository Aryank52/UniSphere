...
class NotificationService {
    static { this.transporter = nodemailer_1.default.createTransport({
    ...
    static async sendSMS(toPhoneNumber, bodyText) {
    ...
    static async sendPushNotification(userToken, title, body) {
