    ...
    <div className="space-y-8 animate-in fade-in duration-500 font-sans select-none pb-12 bg-slate-50/50">
      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 bg-white border border-slate-200 rounded-3xl p-6 md:p-8 shadow-sm">
        ...
        <div className="shrink-0">
          <div className="inline-flex items-center gap-1.5 px-4 py-2 bg-white border border-slate-200 rounded-2xl text-xs font-bold text-slate-800 shadow-sm hover:bg-slate-50 transition-colors">
            <Zap className="h-4.5 w-4.5 text-cyan-600 fill-cyan-100" />
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm flex flex-col justify-between min-h-[180px]">
            <div>
              ...
              <div className="h-2 w-full bg-slate-100 rounded-full mt-4 overflow-hidden">
                <div className="h-full bg-cyan-500 rounded-full transition-all duration-500" style={{ width: '93%' }} />
              </div>
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-4">
            ...
            <button 
              ...
              className="text-cyan-750 hover:text-cyan-800 text-[11px] font-extrabold flex items-center gap-1.5 mt-2 transition-colors cursor-pointer hover:underline"
            >
          ...
          <div>
            ...
            <div className="relative border-l border-slate-100 pl-6 space-y-6 ml-2 text-xs">
              ...
              <div className="relative">
                {/* Dot */}
                <div className="absolute -left-[30px] top-1.5 h-3 w-3 rounded-full bg-cyan-500 ring-4 ring-cyan-50" />
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-1 text-cyan-750 font-extrabold mt-1.5 hover:underline"
                >
      ...
      <div className="space-y-4 pt-4">
        ...
        <div className="flex justify-between items-end">
          ...
          <a 
            ...
            className="text-cyan-750 hover:text-cyan-800 text-xs font-bold hover:underline cursor-pointer"
          >
            Explore More
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm flex flex-col justify-between min-h-[340px]">
            <div className="relative h-40 overflow-hidden">
              ...
              {/* Badge */}
              <span className="absolute top-4 right-4 bg-cyan-50 border border-cyan-150 text-cyan-700 text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full">
                98% Match
              </span>
            </div>
            ...
            <div className="p-5 flex-1 flex flex-col justify-between">
              ...
              <button 
                ...
                className="w-full mt-6 bg-cyan-400 hover:bg-cyan-500 text-slate-900 font-extrabold text-xs py-3 rounded-2xl transition-all text-center cursor-pointer shadow-md active:scale-[0.98]"
              >
                Request to Join
              </button>
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm flex flex-col justify-between min-h-[340px]">
            ...
            <div className="p-5 flex-1 flex flex-col justify-between">
              ...
              <button 
                ...
                className="w-full mt-6 bg-white border border-cyan-300 hover:bg-cyan-50/20 text-cyan-700 font-extrabold text-xs py-3 rounded-2xl transition-all text-center cursor-pointer shadow-sm active:scale-[0.98]"
              >
                Register Free
              </button>
            </div>
      ...
      <div className="flex justify-end pt-4">
        <button 
          ...
          className="fixed bottom-6 right-6 h-12 w-12 rounded-full bg-cyan-400 hover:bg-cyan-500 text-slate-900 flex items-center justify-center shadow-lg shadow-cyan-400/30 active:scale-[0.95] transition-all hover:scale-105 z-40 cursor-pointer"
      ...
      >
        <div className="space-y-4 text-sm text-slate-600">
          ...
          <div className="flex justify-end pt-2">
            <Button variant="primary" className="bg-cyan-400 hover:bg-cyan-500 text-slate-900 font-extrabold" onClick={() => setModalOpen(false)}>
              Okay, Got It
            </Button>
          </div>
        </div>
