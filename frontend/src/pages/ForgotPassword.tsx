        ...
        <Card className="w-full max-w-md bg-white border border-sky-100 rounded-3xl p-8 shadow-travel text-left">
          ...
          {!success ? (
            <>
              ...
              <p className="text-xs text-slate-500 font-semibold mt-1 mb-6">Enter your registered email address and we'll send you a password reset link.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  <label className="text-[10px] font-black text-slate-400 tracking-wider uppercase pl-1">Email Address</label>
            ...
            <div className="text-center py-6 space-y-4">
              ...
              <h2 className="text-xl font-black text-slate-800 tracking-tight">Reset Link Dispatched</h2>
              <p className="text-xs text-slate-500 font-semibold leading-relaxed">
                If the email exists in our records, a secure password reset link has been dispatched to <strong>{email}</strong>.
              </p>
            </div>
          )}

          <div className="mt-8 border-t border-slate-100 pt-5 flex justify-center">
            <Link to="/login" className="text-slate-450 hover:text-slate-700 text-xs font-bold flex items-center gap-1.5">
